...
namespace SharpGL_Programming
{
    public partial class Paint : Form
    {
        ...
        int trans_type;
        bool is_trans;
        float move_x_val, move_y_val, shx_val, shy_val, scale_x_val, scale_y_val;
        int rotate_deg_val;
        ...
        private void openGLControl_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            temp = polygon_vertices.ToList();
            temp.Add(e.Location);
            shape_arr[shape_type].Vertices = temp;
        }
        ...
        private void trans_move_Click(object sender, EventArgs e)
        {
            int len = drawnlist.Count();
            utils.Affine af = new utils.Affine();
            af.Move(move_x_val, move_y_val);
        ...
        private void trans_rotate_Click(object sender, EventArgs e)
        {
            int len = drawnlist.Count();
            utils.Affine af = new utils.Affine();
            af.Rotate(rotate_deg_val);
        ...
        private void trans_scale_Click(object sender, EventArgs e)
        {
            int len = drawnlist.Count();
            utils.Affine af = new utils.Affine();
            af.Scale(scale_x_val, scale_y_val);
        ...
        private void trans_flip_ox_Click(object sender, EventArgs e)
        {
            OpenGL gl = openGLControl.OpenGL;
            int len = drawnlist.Count();
            utils.Affine af = new utils.Affine();
            af.Flip(0);
            af.Move(0, -(float)gl.RenderContextProvider.Height);
        ...
        private void trans_flip_oy_Click(object sender, EventArgs e)
        {
            OpenGL gl = openGLControl.OpenGL;
            int len = drawnlist.Count();
            utils.Affine af = new utils.Affine();
            af.Flip(1);
            af.Move(-(float)gl.RenderContextProvider.Width, 0);
        ...
        private void trans_shx_Click(object sender, EventArgs e)
        {
            int len = drawnlist.Count();
            utils.Affine af = new utils.Affine();
            af.Shift(0, shx_val);
        ...
        //              get value of transformation

        private void move_x_TextChanged(object sender, EventArgs e)
        {
            int userVal;
            if (int.TryParse(move_x.Text, out userVal))
            {
                move_x_val = userVal;
            }
            else
        ...
        private void move_y_TextChanged(object sender, EventArgs e)
        {
            int userVal;
            if (int.TryParse(move_y.Text, out userVal))
            {
                move_y_val = userVal;
            }
            else
        ...
        private void rotate_deg_TextChanged(object sender, EventArgs e)
        {
            int userVal;
            if (int.TryParse(rotate_deg.Text, out userVal))
            {
                rotate_deg_val = userVal;
            }
            else
            { MessageBox.Show("Hey, we need an int over here."); }
        }
        ...
        private void shx_TextChanged(object sender, EventArgs e)
        {
            float userVal;
            if (float.TryParse(shx.Text, out userVal))
            {
                shx_val = userVal;
            }
            else
        ...
        private void shy_TextChanged(object sender, EventArgs e)
        {
            float userVal;
            if (float.TryParse(shy.Text, out userVal))
            {
                shy_val = userVal;
            }
            else

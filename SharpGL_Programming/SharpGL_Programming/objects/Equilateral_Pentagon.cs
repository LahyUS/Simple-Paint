...
{
    class Equilateral_Pentagon : Shape
    {
        ...
        // constructor
        public Equilateral_Pentagon(Point Start, Point End, Color Color, float line_width, bool filled)
        {
            this.start = Start;
            this.end = End;
            this.mycolor = Color;
        ...
        public void drawShape(OpenGL gl, Color color, float line_width)
        {
            ...
            // define edge length of pentagon
